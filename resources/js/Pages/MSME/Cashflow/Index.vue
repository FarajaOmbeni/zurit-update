                    ...
                    <div class="p-6">
                        <div class="mb-6">
                            ...
                            <p class="text-gray-600 mt-2">
                                Track your income and expenses with detailed
                                analytics
                            </p>
                        </div>
                        ...
                        >
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm text-green-800">
                                            <strong>Tip:</strong> Record
                                            transactions daily for accurate
                                            financial reports. Use "Credit"
                                            payment type for sales/purchases on
                                            credit - this automatically creates
                            ...
                            <!-- Action Buttons -->
                            <div
                                class="flex flex-col sm:flex-row gap-3 lg:flex-shrink-0"
                            >
                                <button
                                    @click="openAddModal"
                                ...
                                <div>
                                    ...
                                    >
                                        {{
                                            ...
                                            summary.income_growth?.toFixed(1)
                                        }}%
                                    </p>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    >
                                        {{
                                            ...
                                            summary.expense_growth?.toFixed(1)
                                        }}%
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p
                                        :class="[
                                            'text-sm',
                                            summary.net_growth >= 0
                                                ? 'text-green-600'
                                                : 'text-red-600',
                                        ]"
                                    >
                                        {{ summary.net_growth >= 0 ? "+" : ""
                                        }}{{ summary.net_growth?.toFixed(1) }}%
                                    </p>
                                </div>
                            </div>
                        </div>
...
const exportCsv = () => {
    const rows = [
        ["Date", "Type", "Description", "Category", "Payment Method", "Amount"],
    ...
    link.href = url;
    const now = new Date();
    link.download = `cashflow_entries_${now.toISOString().slice(0, 10)}.csv`;
