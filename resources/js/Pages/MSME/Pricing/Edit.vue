<template>
    <Head title="Edit Pricing Model" />
    <MSMESidebar title="Edit Pricing Model">
        <div class="py-6">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mt-2">
                            Update your pricing model for
                            {{ pricingModel.product_service_name }}
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form @submit.prevent="submitForm" class="p-6 space-y-6">
                        ...
                        >
                            <Link
                                :href="route('pricing.show', pricingModel.id)"
...
const form = useForm({
    product_service_name: props.pricingModel.product_service_name,
    product_type: props.pricingModel.product_type,
    industry_template: props.pricingModel.industry_template || "",
    raw_material_cost: props.pricingModel.raw_material_cost,
    direct_labor_cost: props.pricingModel.direct_labor_cost,
    variable_overhead_cost: props.pricingModel.variable_overhead_cost,
    fixed_overhead_cost: props.pricingModel.fixed_overhead_cost,
    desired_profit_margin: props.pricingModel.desired_profit_margin,
    competitor_price_low: props.pricingModel.competitor_price_low,
    competitor_price_high: props.pricingModel.competitor_price_high,
    market_positioning: props.pricingModel.market_positioning || "",
    units_per_period: props.pricingModel.units_per_period,
    period_type: props.pricingModel.period_type,
    seasonal_adjustment: props.pricingModel.seasonal_adjustment || 0,
    notes: props.pricingModel.notes || "",
    is_active: props.pricingModel.is_active,
});
...
const submitForm = () => {
    form.put(route("pricing.update", props.pricingModel.id), {
        onSuccess: () => {
