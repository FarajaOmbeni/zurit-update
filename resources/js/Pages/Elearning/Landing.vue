<template>
    ...
    <ElearningSidebar title="E-Learning">
        <div class="min-h-screen">
            <!-- Hero Section -->
            <header 
                class="text-white py-20 relative overflow-hidden pt-32"
                        ...
                        >
                            ...
                            <div class="p-6 flex-grow">
                                ...
                                <div v-if="course.sub_courses && course.sub_courses.length > 0" class="mb-4">
                                    ...
                                    <div class="space-y-1">
                                        <div v-for="subCourse in course.sub_courses.slice(0, 2)" :key="subCourse.id" class="flex items-center space-x-2">
                ...
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-gray-600">Access your courses anytime, anywhere with our mobile-friendly platform</p>
                        </div>
