    ...
    <Sidebar title="Course Quiz">
        <div class="bg-gray-50 min-h-screen">
                ...
                <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <div class="text-2xl font-bold text-indigo-600">{{ Math.round((currentQuestionIndex + 1) / quiz.questions.length * 100) }}%</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div v-if="latestAttempt && showAttemptStatus" class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
                    <div class="text-center">
                        <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                >
                                    <svg v-if="latestAttempt.passed" class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div v-if="currentQuestion && (!latestAttempt || !showAttemptStatus)" class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                    <!-- Question -->
                    <div class="mb-8">
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            ...
                            >
                                <div class="flex items-center justify-center w-6 h-6 rounded-full border-2 mr-4"
                                    :class="{
                                        'border-indigo-500 bg-indigo-500': answers[currentQuestion.id] === choice.id,
                                        'border-gray-300': answers[currentQuestion.id] !== choice.id
                                    }"
                                >
                                    <div v-if="answers[currentQuestion.id] === choice.id" class="w-2 h-2 bg-white rounded-full"></div>
                                </div>
