<template>
    ...
    <ElearningSidebar title="Course Details">
        <div class="bg-gray-50 min-h-screen">
            ...
            <!-- Course Hero Section -->
            <div class="text-white py-12 md:py-16" style="
                                    ...
                                    <div class="course-includes">
                                        ...
                                        <ul class="list-none p-0 m-0">
                                            <li v-for="material in course.materials" :key="material.id"
                                                ...
                                                <svg class="w-4 h-4 stroke-2 flex-shrink-0" style="color: #667eea"
                    ...
                    <div class="grid grid-cols-1 gap-12">
                        <div class="main-content">
                            <div class="materials-section mb-8">
                                ...
                                <div v-for="(
group, groupTitle
                                    ) in groupedMaterials" :key="groupTitle" class="mb-8">
                                    <h3 class="text-xl font-medium text-gray-800 mb-4">
                                        {{ groupTitle }}
                                    </h3>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div v-for="material in group" :key="material.id"
                                            ...
                                            <div v-if="!material.is_video" class="mb-4">
                                                <div
                                            ...
                                            <div class="flex items-center gap-3 mb-5">
                                                <!-- PDF Icon -->
                                                <svg v-if="!material.is_video" class="w-6 h-6 flex-shrink-0"
                                                    style="color: #667eea" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor">
                                                    <path
                                                ...
                                                <!-- Video Icon -->
                                                <svg v-else class="w-6 h-6 flex-shrink-0" style="color: #667eea"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor">
