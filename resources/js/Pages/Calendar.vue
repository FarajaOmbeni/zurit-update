...
onMounted(async () => {
    try {
        ...
        const rawEvents = [
            ...
            { id: 'corp1', title: "Prosperity Circles", topic: "Using NSSF / Pension to save on tax", date_start: "2025-04-05", type: "corporate_monthly", location: "Virtual / Physical (Nairobi)", price: "Ksh 1,500 physical / 1,000 virtual", link: "https://dashboard.mailerlite.com/forms/1042116/153540946091312633/share" },
            { id: 'corp2', title: "Prosperity Circles", topic: "How to Navigate Financial Changes", date_start: "2025-05-31", type: "corporate_monthly", location: "Virtual / Physical", price: "Ksh 1,500 physical / 1,000 virtual", link: "https://dashboard.mailerlite.com/forms/1042116/153540946091312633/share" },
            { id: 'corp3', title: "Prosperity Circles", topic: "Debt-Detox – How to clean up your Finances and Prosper", date_start: "2025-06-28", type: "corporate_monthly", location: "Virtual / Physical", price: "Ksh 1,500 physical / 1,000 virtual", link: "https://dashboard.mailerlite.com/forms/1042116/153540946091312633/share" },
            { id: 'corp4', title: "Prosperity Circles", topic: "The Timeless Principles of Wealth Creation", date_start: "2025-07-26", type: "corporate_monthly", location: "Virtual / Physical", price: "Ksh 1,500 physical / 1,000 virtual", link: "https://dashboard.mailerlite.com/forms/1042116/153540946091312633/share" },
            { id: 'corp5', title: "Prosperity Circles", topic: "Back to the Drawing Board – How to Implement Your Financial Plan", date_start: "2025-08-30", type: "corporate_monthly", location: "Virtual / Physical", price: "Ksh 1,500 physical / 1,000 virtual", link: "https://dashboard.mailerlite.com/forms/1042116/153540946091312633/share" },
            { id: 'corp6', title: "Prosperity Circles", topic: "Securing Your Retirement", date_start: "2025-09-27", type: "corporate_monthly", location: "Virtual / Physical", price: "Ksh 1,500 physical / 1,000 virtual", link: "https://dashboard.mailerlite.com/forms/1042116/153540946091312633/share" },
            { id: 'corp7', title: "Prosperity Circles", topic: "How Businesses Can Successfully Invest in Financial Markets", date_start: "2025-10-31", type: "corporate_monthly", location: "Virtual / Physical", price: "Ksh 1,500 physical / 1,000 virtual", link: "https://dashboard.mailerlite.com/forms/1042116/153540946091312633/share" },
            { id: 'corp8', title: "Prosperity Circles", topic: "Strategies Businesses Can Adopt to Protect and Grow Wealth", date_start: "2025-11-29", type: "corporate_monthly", location: "Virtual / Physical", price: "Ksh 1,500 physical / 1,000 virtual", link: "https://dashboard.mailerlite.com/forms/1042116/153540946091312633/share" },
            { id: 'corp9', title: "Prosperity Circles", topic: "Scaling Businesses Effectively to Increase Market Value", date_start: "2025-12-20", type: "corporate_monthly", location: "Virtual / Physical", price: "Ksh 1,500 physical / 1,000 virtual", link: "https://dashboard.mailerlite.com/forms/1042116/153540946091312633/share" },

            // ─────────────────────── Prosperity Masterclass (monthly cohort) ────────────
            ...
            { id: 'ret1', title: "Retirement Planning", date_start: "2025-04-14", date_end: "2025-04-18", type: "retirement_planning", location: "Mombasa", price: "Ksh 79,000 excl. VAT", topic: "Taking Stock, Mental Preparedness, Financial Well-being, Health, Investment Options in Retirement" },
            { id: 'ret2', title: "From Salary to Security: Your Path to a Prosperous Retirement", date_start: "2025-10-15", date_end: "2025-10-17", type: "retirement_planning", location: "Machakos", price: "Ksh 79,000 excl. VAT", topic: "Taking Stock, Mental Preparedness, Financial Well-being, Health, Investment Options in Retirement" },
            { id: 'ret3', title: "From Salary to Security: Your Path to a Prosperous Retirement", date_start: "2026-04-13", date_end: "2026-04-17", type: "retirement_planning", location: "Nairobi", price: "Ksh 79,000 excl. VAT", topic: "Taking Stock, Mental Preparedness, Financial Well-being, Health, Investment Options in Retirement" },

            // ───────────────────────── Alternative Investments (5-day) ──────────────────
            { id: 'alt1', title: "Alternative Investments", date_start: "2025-05-12", date_end: "2025-05-16", type: "alternative_investments", location: "Nanyuki", price: "Ksh 79,000 excl. VAT", topic: "Investment Landscape, Fixed Income, Equities, Real Estate, Offshore, Private Equity, Portfolio & Risk Mgmt, Personal Finance", link: "https://dashboard.mailerlite.com/forms/1042116/152526113162135515/share" },
            { id: 'alt2', title: "Alternative Investments", date_start: "2025-06-09", date_end: "2025-06-13", type: "alternative_investments", location: "Kisumu", price: "Ksh 79,000 excl. VAT", topic: "Investment Landscape, Fixed Income, Equities, Real Estate, Offshore, Private Equity, Portfolio & Risk Mgmt, Personal Finance", link: "https://dashboard.mailerlite.com/forms/1042116/152526113162135515/share" },
            { id: 'alt3', title: "Alternative Investments", date_start: "2025-11-10", date_end: "2025-11-14", type: "alternative_investments", location: "Naivasha", price: "Ksh 79,000 excl. VAT", topic: "Investment Landscape, Fixed Income, Equities, Real Estate, Offshore, Private Equity, Portfolio & Risk Mgmt, Personal Finance", link: "https://dashboard.mailerlite.com/forms/1042116/152526113162135515/share" },
            { id: 'alt4', title: "Alternative Investments", date_start: "2026-02-09", date_end: "2026-02-13", type: "alternative_investments", location: "Kisumu", price: "Ksh 79,000 excl. VAT", topic: "Investment Landscape, Fixed Income, Equities, Real Estate, Offshore, Private Equity, Portfolio & Risk Mgmt, Personal Finance", link: "https://dashboard.mailerlite.com/forms/1042116/152526113162135515/share" },
            { id: 'alt5', title: "Alternative Investments", date_start: "2026-05-11", date_end: "2026-05-15", type: "alternative_investments", location: "Kisumu", price: "Ksh 79,000 excl. VAT", topic: "Investment Landscape, Fixed Income, Equities, Real Estate, Offshore, Private Equity, Portfolio & Risk Mgmt, Personal Finance", link: "https://dashboard.mailerlite.com/forms/1042116/152526113162135515/share" },

            // ───────────────────── Fundamentals of Investments (5-day) ──────────────────
            { id: 'fund1', title: "Fundamentals of Investments", date_start: "2025-08-18", date_end: "2025-08-22", type: "fundamentals_investments", location: "Machakos", price: "Ksh 79,000 excl. VAT", topic: "Investment Landscape, Fixed Income, Equities, Real Estate, Offshore, Portfolio Construction, Risk & Performance Management, Personal Finance" },
            { id: 'fund2', title: "Fundamentals of Investments", date_start: "2026-01-05", date_end: "2026-01-09", type: "fundamentals_investments", location: "Machakos", price: "Ksh 79,000 excl. VAT", topic: "Investment Landscape, Fixed Income, Equities, Real Estate, Offshore, Portfolio Construction, Risk & Performance Management, Personal Finance" },
            { id: 'fund3', title: "Fundamentals of Investments", date_start: "2026-06-15", date_end: "2026-06-19", type: "fundamentals_investments", location: "Machakos", price: "Ksh 79,000 excl. VAT", topic: "Investment Landscape, Fixed Income, Equities, Real Estate, Offshore, Portfolio Construction, Risk & Performance Management, Personal Finance" },
            ...
            { id: 'strat2', title: "Strategic Governance & Oversight of Complex Investment Portfolios", date_start: "2025-12-08", date_end: "2025-12-12", type: "strategic_governance", location: "Mombasa", price: "Ksh 79,000 excl. VAT", topic: "Strengthen governance, interrogate portfolio strategies, red-flag detection, ethical decision-making, long-term wealth security" },
            { id: 'strat3', title: "Strategic Governance & Oversight of Complex Investment Portfolios", date_start: "2026-03-09", date_end: "2026-03-13", type: "strategic_governance", location: "Naivasha", price: "Ksh 79,000 excl. VAT", topic: "Strengthen governance, interrogate portfolio strategies, red-flag detection, ethical decision-making, long-term wealth security" },
            ...
            { id: 'webinar1', title: "Bi-Weekly Webinar", type: "webinar_bi_weekly", price: "Free", location: "Virtual", topic: "Asset-class discussions", details: "Every Tuesday at 7 PM" }
        ];
