<template>
    <Head title="Wealth Score Questionnaire" />
    <Navbar />
    <div class="flex justify-center">
        <div
            ...
            <h2 class="text-lg md:text-2xl font-bold text-center text-purple-800 mb-6">Wealth Score Questionnaire 💰</h2>
            <p class="mb-6 text-center">Instructions: For each question, select the answer that best describes your financial habits. At the end, add up your score to determine your Wealth Score Level.</p>

            <!-- User Information -->
            <div class="mb-4">
                <label class="block text-gray-700 font-medium mt-2">Name:</label>
                <input required v-model="userInfo.name" type="text" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500" placeholder="Enter your name" />

                <label class="block text-gray-700 font-medium mt-2">Email:</label>
                <input required v-model="userInfo.email" type="email" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500" placeholder="Enter your email" />

                <label class="block text-gray-700 font-medium mt-2">Phone Number:</label>
                <input required v-model="userInfo.phone" type="phone" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500" placeholder="Enter your phone number" />
            </div>
            ...
            <div class="mb-4">
                ...
                <select v-model="scores.goalSetting1" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500">
                ...
                <label class="block text-gray-700 font-medium mt-2">Do you have a financial plan for achieving your goals?</label>
                <select v-model="scores.goalSetting2" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500">
            ...
            <div class="mb-4">
                ...
                <select v-model="scores.investmentPlanning1" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500">
                ...
                <select v-model="scores.investmentPlanning2" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500">
            ...
            <div class="mb-4">
                ...
                <select v-model="scores.debtManagement1" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500">
                ...
                <label class="block text-gray-700 font-medium mt-2">If you had to take a loan, what would be your reason?</label>
                <select v-model="scores.debtManagement2" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500">
            ...
            <div class="mb-4">
                ...
                <label class="block text-gray-700 font-medium mt-2">How do you track your income and expenses?</label>
                <select v-model="scores.budgetPlanning1" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500">
                ...
                <label class="block text-gray-700 font-medium mt-2">How much of your income do you save each month?</label>
                <select v-model="scores.budgetPlanning2" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500">
            ...
            <div class="mb-4">
                ...
                <label class="block text-gray-700 font-medium mt-2">What is the best way to build wealth over time?</label>
                <select v-model="scores.financialKnowledge1" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500">
                ...
                <select v-model="scores.financialKnowledge2" class="w-full px-4 py-2 mt-1 border rounded-md focus:ring-2 focus:ring-purple-500">
