<template>
    <div class="bg-white rounded-2xl shadow-lg p-4 border border-purple-200 text-center md:text-start">
        <div class="flex justify-center">
            <img :src="image" alt="Blog Image" :class="displaying ? 'w-[25rem] h-[16rem]' : ''"
        ...
        <div v-html="content" :class="clamped ? 'line-clamp-3' : ''"
            class="text-gray-600 mt-1 leading-loose text-justify"></div>
