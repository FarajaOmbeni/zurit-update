export const moneyMarketFunds = [
    { value: "cytonn_mmf", label: "Cytonn Money Market Fund", return: "13.30" },
    {
        value: "gulfcap_mmf",
    ...
    { value: "kuza_mmf", label: "Kuza Money Market Fund", return: "12.12" },
    { value: "etica_mmf", label: "Etica Money Market Fund", return: "12.02" },
    { value: "avocap_mmf", label: "Avocap Money Market Fund", return: "11.75" },
    {
        value: "genafrica_mmf",
    ...
    { value: "apollo_mmf", label: "Apollo Money Market Fund", return: "10.20" },
    { value: "faulu_mmf", label: "Faulu Money Market Fund", return: "10.18" },
    { value: "sanlam_mmf", label: "Sanlam Money Market Fund", return: "10.10" },
    { value: "kcb_mmf", label: "KCB Money Market Fund", return: "9.83" },
    {
        value: "icea_lion_mmf",
        label: "ICEA Lion Money Market Fund",
        return: "9.35",
    },
    { value: "co_op_mmf", label: "Co-op Money Market Fund", return: "9.20" },
    { value: "mali_mmf", label: "Mali Money Market Fund", return: "9.18" },
    {
        value: "genghis_mmf",
    ...
    {
        value: "aa_kenya_shillings_mmf",
        label: "AA Kenya Shillings Fund",
        return: "7.83",
    },
    { value: "zidi_mmf", label: "Zidi Money Market Fund", return: "6.85" },
    {
        value: "stanbic_mmf",
        label: "Stanbic Money Market Fund",
        return: "6.58",
    },
    { value: "cpf_mmf", label: "CPF Money Market Fund", return: "6.08" },
    { value: "equity_mmf", label: "Equity Money Market Fund", return: "5.12" },
];
...
export const shares = [
    ...
    { ticker: "ABSA - Absa Bank Kenya PLC", price: 19.9 },
    { ticker: "COOP - Co-operative Bank of Kenya Ltd", price: 17.05 },
    { ticker: "NCBA - NCBA Group PLC", price: 63.5 },
    ...
    { ticker: "BKG - BK Group PLC", price: 35.1 },
    ...
    { ticker: "CRWN - Crown Paints Kenya PLC", price: 37.3 },
    { ticker: "CARB - Carbacid Investments Plc", price: 20.7 },
    { ticker: "LBTY - Liberty Kenya Holdings Plc", price: 10.9 },
    { ticker: "TPSE - TPS Eastern Africa Plc", price: 15.2 },
